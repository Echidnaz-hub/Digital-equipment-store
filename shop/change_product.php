                    ...
                    <div class="main__container">
                        ...
                        <div class="body__data">
                            <?php 
                                $value = $_GET['id'];
                            ?>
                            <form action="change_script.php" method="POST" class="body__form" enctype="multipart/form-data">
                                <input type="hidden" name="id" value=<?php echo $value ?>>
                                <div class="body__field">
                                    <input type="text" class="body__input" name="name" placeholder="Название" require>
                                </div>
                                <div class="body__field">
                                    <input type="number" class="body__input" name="price" placeholder="Стоимость" require>
                                </div>
                                <div class="body__field">
                                    <input type="file" class="body__input" name="image" placeholder="Изображение" require>
                                </div>
                                <div class="body__btn">
                                    <button type="submit" class="body__button">Изменить</button>
                                </div>
                            </form>
                        </div>
                    </div>
